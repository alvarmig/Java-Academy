...
public class CalculatorFX extends Application {
    ...
    public void start(Stage window) {
        ...
        try {
            ...
            root = FXMLLoader.load(getClass().getResource("/Resources/Views/sceneCalculator.fxml"));
            ...
            java.util.logging.Logger.getLogger(CalculatorFX.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            //JOptionPane.
